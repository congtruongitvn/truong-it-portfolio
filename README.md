...
| Dự án | Mô tả | Link |
|-------|--------|------|
| **ZaloMulti-Win** | Quản lý & chạy đồng thời nhiều tài khoản Zalo Desktop trên Windows | [GitHub](https://github.com/nct88/ZaloMulti-Win) · [Demo](https://nct88.github.io/ZaloMulti-Win/) |
| **ZaloMulti-Mac** | Nhân bản và chạy song song nhiều Zalo trên macOS | [GitHub](https://github.com/nct88/ZaloMulti-Mac) · [Demo](https://nct88.github.io/ZaloMulti-Mac/) |
| **Messenger Premium** | Ứng dụng Messenger Desktop cho Windows (Electron) | [GitHub](https://github.com/nct88/messenger-pc) |
| **Portfolio** | Trang cá nhân & trang Donate qua SePay | [Live](https://nct88.github.io/portfolio/) |
...
👉 **[Ủng hộ truong.it](https://nct88.github.io/portfolio/donate/)**
